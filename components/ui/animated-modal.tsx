...
export const ModalTrigger: React.FC<ModalComponentProps> = ({
  children,
  className,
}) => {
...
export const ModalContent: React.FC<ModalComponentProps> = ({
  children,
  className,
}) => {
  return (
...
const Overlay: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <motion.div
      initial={{
        opacity: 0,
